...
class Advert_Narrow_Widget extends WP_Widget {

    /**
     * Advert_Narrow_Widget constructor.
     *
    ...
    public function __construct()
    {
        parent::__construct(
            'advert_narrow',
            __('Advert Narrow Widget', 'theme'),
            array(
                'description' => __('Narrow widget displaying an advert.', 'theme')
            )
        );
    }
    ...
    public function widget($args = array(), $instance = array())
    {
        if(!empty($instance['ad_tag']))
            require(get_template_directory() .'/templates/widgets/advert-narrow-widget.php');
    }
