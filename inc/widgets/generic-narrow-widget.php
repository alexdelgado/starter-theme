...
class Generic_Narrow_Widget extends WP_Widget {

    /**
     * Generic_Narrow_Widget constructor.
     *
    ...
    public function __construct()
    {
        parent::__construct(
            'generic_narrow',
            __('Generic Narrow Widget', 'theme'),
            array(
                'description' => __('Generic narrow widget.', 'theme'),
            )
        );
    }
    ...
    public function widget($args = array(), $instance = array())
    {
        ...
        require(get_template_directory() .'/templates/widgets/generic-narrow-widget.php');
    }
